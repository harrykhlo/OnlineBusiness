...
function NewSaleModal(props) {
    ...
    //const todaySQL = "2020" + "-" + "8" + "-" + "25" + "T00:00:00"

    //const todaySQL = todayJavaScript.getFullYear().toString() + "-" + (todayJavaScript.getMonth() + 1).toString() + "-" + todayJavaScript.getDate().toString()
